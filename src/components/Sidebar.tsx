      ...
      >
        ...
        <div className="p-3.5 m-3.5 bg-[#0B1528] border border-[#1E2E48] rounded-2xl">
          ...
          <button
            ...
            className="w-full bg-[#030712] hover:bg-[#112240] text-[#C5A880] hover:text-white py-2 px-3 rounded-xl text-xs font-medium transition-colors flex items-center justify-center gap-1.5 border border-[#1E2E48] cursor-pointer"
          >
            <LogOut className="w-3.5 h-3.5" />
            <span>Switch / Edit Login</span>
          </button>
        </div>
      </aside>
    </>
