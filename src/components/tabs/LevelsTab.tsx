...
export const LevelsTab: React.FC<LevelsTabProps> = ({ userProfile }) => {
  const pathwayLevels = [
    ...
    },
    {
      ...
      icon: Crown,
      iconBg: 'bg-[#030712] text-[#C5A880] border-[#C5A880]',
  ...
  const renderBadge = (type: string, title: string) => {
    switch (type) {
      case 'bronze':
        return (
          <div className="flex flex-col items-center text-center">
            ...
            <span className="text-[10px] font-bold font-cinzel text-[#C5A880] uppercase mt-2 tracking-wider max-w-[110px] text-center leading-tight">
              {title}
            </span>
          </div>
        );
      ...
      default:
        return (
          <div className="flex flex-col items-center text-center">
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#02050B] via-[#0A192F] to-[#040A17] border-2 border-[#C5A880] shadow-xl flex items-center justify-center p-1 relative">
              <div className="w-12 h-12 rounded-full border border-[#C5A880]/50 flex items-center justify-center bg-[#C5A880]/20">
                <Crown className="w-6 h-6 text-[#C5A880] fill-[#C5A880]/30 drop-shadow" />
              </div>
            </div>
            <span className="text-[10px] font-bold font-cinzel text-[#C5A880] uppercase mt-2 tracking-wider max-w-[110px] text-center leading-tight">
              {title}
  ...
  return (
    <div className="space-y-8 animate-fadeIn max-w-6xl mx-auto text-slate-100">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-[#02050B] via-[#08101E] to-[#030712] border-2 border-[#C5A880]/60 p-6 sm:p-10 shadow-2xl text-center space-y-4">
        {/* Crest Logo Top Center */}
        <div className="flex justify-center">
          <SocietyLogo size="xl" className="shadow-2xl border-2 border-[#C5A880]/60" />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs sm:text-sm font-semibold tracking-widest text-[#C5A880] uppercase font-sans">
            A Public Speaking &amp; Leadership Club &bull; Sri Amaraavathi College of Arts and Science, Karur
          </p>

          {/* Ribbon Motto */}
          <div className="pt-2 flex justify-center">
            <div className="inline-block bg-[#0E1E38] text-white px-8 py-2 rounded-xl font-cinzel font-bold text-xs sm:text-sm tracking-[0.3em] shadow-lg border border-[#C5A880]/60">
              <span className="text-[#C5A880]">SPEAK</span> &bull; <span className="text-white">LEAD</span> &bull; <span className="text-[#C5A880]">INSPIRE</span>
            </div>
          </div>
        </div>

        {/* Pathway Title with Golden Stars */}
        <div className="pt-3 border-t border-[#1E2E48] max-w-xl mx-auto">
      ...
      <div className="space-y-5">
        {pathwayLevels.map((lvl) => {
          ...
          return (
            <div
              key={lvl.levelNumber}
              className="bg-[#050B14] rounded-2xl border-2 border-[#1E2E48] hover:border-[#C5A880] shadow-xl hover:shadow-2xl transition-all p-5 sm:p-7 relative overflow-hidden"
            >
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
                ...
                <div className="lg:col-span-4 flex items-start sm:items-center gap-4">
                  ...
                  <div className="flex flex-col items-center shrink-0">
                    <div className="w-14 h-14 rounded-2xl bg-[#0B1528] text-white border-2 border-[#C5A880] flex flex-col items-center justify-center shadow-md">
                      <span className="text-[9px] font-cinzel tracking-wider text-[#C5A880] uppercase leading-none">
                        LEVEL
                      </span>
                ...
                <div className="lg:col-span-5 bg-[#0B1528] rounded-xl p-4 border border-[#1E2E48] space-y-2">
                  <div className="inline-block bg-[#030712] border border-[#1E2E48] text-[#C5A880] text-[10px] font-cinzel font-bold px-3 py-0.5 rounded tracking-wider mb-1">
                    MILESTONES
                  </div>
                ...
                <div className="lg:col-span-3 flex flex-col items-center justify-center border-t lg:border-t-0 lg:border-l border-[#1E2E48] pt-4 lg:pt-0 lg:pl-4">
                  <div className="inline-block bg-[#030712] border border-[#1E2E48] text-[#C5A880] text-[10px] font-cinzel font-bold px-3 py-0.5 rounded tracking-wider mb-2.5">
                    RECOGNITION
                  </div>
      ...
      <div className="space-y-3">
        <div className="flex justify-center">
          <div className="inline-block bg-[#0E1E38] text-[#C5A880] text-xs font-cinzel font-bold px-5 py-1.5 rounded-lg tracking-[0.25em] shadow-md border border-[#C5A880]/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 pt-2">
          ...
          <div className="bg-[#050B14] rounded-2xl border border-[#1E2E48] p-6 shadow-xl flex items-start gap-4">
          ...
          <div className="bg-[#050B14] rounded-2xl border border-[#1E2E48] p-6 shadow-xl flex items-start gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-300">
                ...
                <strong className="text-[#C5A880] block font-bold font-cinzel text-xs sm:text-sm mt-0.5">
                  CERTIFIED DECLAMATE!
                </strong>
              </p>
            </div>
      ...
      <div className="rounded-2xl bg-gradient-to-r from-[#02050B] via-[#0A192F] to-[#02050B] text-white p-5 sm:p-6 text-center border border-[#C5A880]/50 shadow-xl">
        <div className="flex items-center justify-center gap-2 text-[#C5A880] mb-1">
          <Star className="w-4 h-4 fill-[#C5A880]" />
